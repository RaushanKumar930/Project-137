...
export default class StarScren extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      data: {},
      url: `https://c21a-103-154-59-83.ngrok-free.app/star?name=${this.props.navigation.getParam("name")}`
    };
  }
      ...
      return (
        ...
        >
          ...
          <View style={styles.middleContainer}>
            <View>
              <Text style={styles.text}>{data.star_mass}</Text>
            ...
            <View>
              <Text style={styles.text}>{data.star_radius}</Text>
